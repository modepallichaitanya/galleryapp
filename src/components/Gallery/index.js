    ...
    return (
      <div className="gallery-container">
        <div className="image-container">
          <img src={imageUrl} alt={imageAltText} className="selected-logo" />
          <h1 className="gallery-heading">Nature Photography</h1>
          <p className="image-info">Nature Photography by Chaitanya</p>
          <ul className="image-logo-container">
            {imagesList.map(eachImage => (
              <ThumbnailItem
                key={eachImage.id}
                isActive={activeThumbnailId === eachImage.id}
                clickItem={this.clickOnImage}
